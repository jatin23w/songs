...
@Component({
    selector: "app-Customer_Experience",
    templateUrl: "./Customer_Experience.component.html",
    styleUrls: ["./Customer_Experience.component.css", ]
})
  

export class Customer_Experiencecomponent implements OnInit {
